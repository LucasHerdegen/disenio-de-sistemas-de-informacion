...
Para utilizar el ecosistema SmartLife, cada cliente debe abonar una cuota mensual. Sin embargo, el monto a pagar depende del tipo de cliente y del plan contratado.
...
El Sistema debe poder calcular cuánto debe pagar un cliente en el mes.
